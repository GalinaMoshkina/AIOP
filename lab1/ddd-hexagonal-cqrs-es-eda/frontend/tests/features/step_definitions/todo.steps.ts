...
type TodoState = ReturnType<typeof todoReducer>;
...
When(
  'a {string} setTodos event arrives with todos:',
  function (this: TodoWorld, type: string, table: DataTable) {
    const todos = parseTodosTable(table);
